...
function VenueInfo() {
    ...
    return (
        <div className="container my-5">
            ...
            <p><strong>Date and Time:</strong> {`${Math.floor(eventData.event_date / 10000)}-${String(Math.floor((eventData.event_date % 10000) / 100)).padStart(2, '0')}-${String(eventData.event_date % 100).padStart(2, '0')}`}</p>
            <p><strong>Sales Start</strong> {eventData.sales_start}</p>
